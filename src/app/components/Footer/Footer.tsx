...
// <!-- Footer Start --> */}
<div className="container-fluid bg-dark text-body footer pt-5 px-0 wow fadeIn" data-wow-delay="0.1s">
    <div className="container py-5">
        <div className="row g-5">
            <div className="col-lg-3 col-md-6">
                <h3 className="text-light mb-4">Address</h3>
                <p className="mb-2"><i className="fa fa-map-marker-alt text-primary me-3"></i>Akhbab, Taif 26513, Saudi Arabia</p>
                <p className="mb-2"><i className="fa fa-phone-alt text-primary me-3"></i>920033002</p>
                <p className="mb-2"><i className="fa fa-envelope text-primary me-3"></i>info@alusaifer.com.sa</p>
