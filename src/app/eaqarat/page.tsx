                    ...
                    <div className="accordion-body">
                      <div>
                        ...
                        <div className="form-check">
                          ...
                          <label className="form-check-labe">ابراج محمدالاصيفر</label>
                        ...
                        <div className="form-check">
                          ...
                          <label className="form-check-label">شقق</label>
                        ...
                        <div className="form-check">
                          ...
                          <label className="form-check-label" id="flexCheckChecked3">فلل</label>
                        ...
                        <div className="form-check">
                          ...
                          <label className="form-check-label" id="flexCheckChecked4">عماير</label>
                          <span className="badge badge-secondary float-end">89</span>
                        </div>
                        {/* <!-- Default checkbox --> */}
                        <div className="form-check">
                          <input className="form-check-input" type="checkbox" value="" id="flexCheckDefault" />
                          <label className="form-check-label" id="flexCheckDefault">اراضي</label>
                      ...
                      <div className="row mb-3">
                        <div className="col-6">
                          ...
                          <div className="form-outline">
                            ...
                            <label className="form-label" id="typeNumber">0</label>
                          </div>
                        </div>
                        <div className="col-6">
                          <p className="mb-0">
                          ...
                          <div className="form-outline">
                            <input type="number" id="typeNumber" className="form-control" />
                            <label className="form-label">1,0000</label>
                          </div>
                        </div>
                      </div>
                      <button type="button" className="btn btn-white w-100 border border-secondary">تطبيق</button>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="row g-0">
                      <div className="col-xl-3 col-md-4 d-flex justify-content-center">
                        <div className="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                          <img src="project6.jpg" className="w-100" />
                          <a href="#!">
                            <div className="hover-overlay">
                              <div className="mask" id="background-color: rgba(253, 253, 253, 0.15);"></div>
                            </div>
                          </a>
                        </div>
                      </div>
                      <div className="col-xl-6 col-md-5 col-sm-7">
                        <h5>ابراج محمد الاصيفر</h5>
